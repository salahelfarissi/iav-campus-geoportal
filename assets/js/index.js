...
(function ($) {
    ...
    const square =
        'https://cdn.jsdelivr.net/gh/salahelfarissi/interactive-iav-campus-map@master/assets/img/popup/inactive.png';
    const squareCheck =
        'https://cdn.jsdelivr.net/gh/salahelfarissi/interactive-iav-campus-map@master/assets/img/popup/active.png';
    ...
    var popupBuild = new mapboxgl.Popup({
        // Popup Hover Bati
        closeButton: false,
        closeOnClick: false,
    });
    ...
    function getiav3D() {
        ...
        map.addLayer(
            ...
            Layers[0]
        ); // ? For pins to be displayed above the layer
    ...
    function getiav2D() {
        ...
        map.on('mousemove', iav2DId, function (e) {
            map.setFilter(iav2DHId, [
                '==',
                'name',
                e.features[0].properties.name,
            ]);
    ...
    function addIconPlacement() {
        ...
        // Basket
        map.loadImage('./assets/img/icons/signage.png', (error, image) => {
            if (error) throw error;
        ...
        // Grass
        map.loadImage('./assets/img/icons/grass.png', (error, image) => {
            if (error) throw error;
        ...
        // tree
        map.loadImage('./assets/img/icons/tree.png', (error, image) => {
            if (error) throw error;
        ...
        // palmier
        map.loadImage('./assets/img/icons/palmier.png', (error, image) => {
            if (error) throw error;
        ...
        // Library
        map.loadImage('./assets/img/icons/horse.png', (error, image) => {
            if (error) throw error;
        ...
        map.loadImage('./assets/img/icons/clinic.png', (error, image) => {
            if (error) throw error;
        ...
        map.loadImage('./assets/img/icons/coffee.png', (error, image) => {
            if (error) throw error;
        ...
        map.loadImage('./assets/img/icons/barrier.png', (error, image) => {
            if (error) throw error;
        ...
        if (type === 'line') {
            if (overlayCount === 0) {
                ...
                if (visibility === 'visible') {
                    for (var i = 0; i < htmlLink.childNodes.length; i++) {
                        if (
                            htmlLink.childNodes[i].className == 'square active'
                        ) {
            ...
            if (overlayCount === 0) {
                if (type === 'marker') {
                    ...
                    map.loadImage(colorOrUrl, (error, image) => {
                        if (error) throw error;
                ...
                function hideLayer(layerName, htmlLink) {
                    if (htmlLink.nodeName === 'LI') {
                        for (var i = 0; i < htmlLink.childNodes.length; i++) {
                            if (
                                htmlLink.childNodes[i].className ===
                                'square active'
                            ) {
                                htmlLink.childNodes[i].classList.remove(
                                    'active'
                                );
                            }
                        }
    ...
    function getPopupContent(feature) {
        ...
        if (
            feature.properties.brochure !== 'null' &&
            feature.properties.brochure !== null &&
            feature.properties.brochure !== ''
        ) {
            console.log(feature.properties.brochure);
            popupContent +=
                '<p>• <b>Brochure</b>' + feature.properties.brochure + '</p>';
        }
        if (
        ...
        if (
            ...
            popupContent +=
                "<img style = 'height : 50px; width : 50px; display : block; margin-left : auto; margin-right : auto; margin-bottom: 5px;' src = '" +
                feature.properties.image +
                "'/>";
            // }
        }
    ...
    function createHTMLList(
        ...
        if (overlayCount == 0) {
            ...
            for (i = 0; i < namesList.length; i++) {
                ...
                var theFunction =
                    'switchPOI(' + "'" + currentName + "');return false;";
    ...
    switchPOI = function (value) {
        ...
        if (document.getElementsByClassName('leaf active')) {
            var previousActiveLeaves =
                document.getElementsByClassName('leaf active');
    ...
    function getSearchPopup() {
        ...
        if (searchItem.properties.brochure != null) {
            popupContent +=
                '<p>• <b>Brochure</b>' +
                searchItem.properties.brochure +
                '</p>';
        }
        ...
        if (searchItem.properties.image != null) {
            popupContent +=
                "<img style = 'height : 50px; width : 50px; display : block; margin-left : auto; margin-right : auto' src = '" +
                searchItem.properties.image +
                "'/>";
        }
    ...
    $('#btnRemovefilters').on('click', function () {
        $(
            'ul#metismenu li:not(.sidebar-search,.sidebar-remove-filters), ul#metismenu li:not(.sidebar-search,.sidebar-remove-filters) a'
        ).each(function (i) {
            if ($(this).attr('id')) {
        ...
        $('ul.metismenu li.mm-active ul.mm-collapse a.active').each(function (
            i
        ) {
        ...
        $(
            'ul.metis-menu li.mm-active:not(.sidebar-search,.sidebar-remove-filters), ul.metis-menu li.mm-active:not(.sidebar-search,.sidebar-remove-filters) ul.mm-show '
        ).each(function (i) {
            if ($(this).hasClass('active')) {
                $(this).removeClass('active');
            }
            if ($(this).hasClass('mm-show')) $(this).removeClass('mm-show');
        });
    });
})(jQuery);
